...
P. Lewis et al., ``Retrieval-Augmented Generation for Knowledge-Intensive NLP Tasks,'' in \textit{Advances in Neural Information Processing Systems}, vol. 33, pp. 9459--9474, 2020.

\bibitem{karpukhin2020dense}
V. Karpukhin et al., ``Dense Passage Retrieval for Open-Domain Question Answering,'' in \textit{Proceedings of EMNLP}, pp. 6769--6781, 2020.

\bibitem{pan2024large}
J. Pan, S. Razniewski, J. Z. Pan, and G. Weikum, ``Large Language Models and Knowledge Graphs: Opportunities and Challenges,'' \textit{Trans. Graph Data Knowledge}, vol. 1, no. 1, pp. 1--38, 2024.
...
N. Carlini et al., ``Extracting Training Data from Large Language Models,'' in \textit{Proceedings of USENIX Security}, pp. 2633--2650, 2021.

\bibitem{izacard2021leveraging}
G. Izacard and E. Grave, ``Leveraging Passage Retrieval with Generative Models for Open Domain Question Answering,'' in \textit{Proceedings of EACL}, pp. 874--880, 2021.

\bibitem{borgeaud2022improving}
S. Borgeaud et al., ``Improving Language Models by Retrieving from Trillions of Tokens,'' in \textit{Proceedings of ICML}, pp. 2206--2240, 2022.

\bibitem{chase2022langchain}
H. Chase, ``LangChain: Building Applications with LLMs through Composability,'' GitHub Repository, 2022.

\bibitem{chakraborty2023survey}
S. Chakraborty et al., ``Survey on Knowledge Graph-based Question Answering Systems,'' \textit{IEEE Access}, vol. 11, pp. 61329--61344, 2023.

\bibitem{yasunaga2021qa}
M. Yasunaga et al., ``QA-GNN: Reasoning with Language Models and Knowledge Graphs for Question Answering,'' in \textit{Proceedings of NAACL}, pp. 535--546, 2021.

\bibitem{pan2024unifying}
S. Pan et al., ``Unifying Large Language Models and Knowledge Graphs: A Roadmap,'' \textit{IEEE Trans. Knowl. Data Eng.}, vol. 36, no. 7, pp. 3580--3599, 2024.

\bibitem{sun2024think}
J. Sun et al., ``Think-on-Graph: Deep and Responsible Reasoning of Large Language Model on Knowledge Graph,'' in \textit{Proceedings of ICLR}, 2024.

\bibitem{microsoft2024graphrag}
Microsoft Research, ``GraphRAG: A Modular Graph-Based RAG System,'' Technical Report, 2024.
...
O. Ram et al., ``In-Context Retrieval-Augmented Language Models,'' \textit{Trans. Assoc. Comput. Linguist.}, vol. 11, pp. 1316--1331, 2023.

\bibitem{muennighoff2023mteb}
N. Muennighoff et al., ``MTEB: Massive Text Embedding Benchmark,'' in \textit{Proceedings of EACL}, pp. 2014--2037, 2023.

\bibitem{mudgal2018deep}
S. Mudgal et al., ``Deep Learning for Entity Matching: A Design Space Exploration,'' in \textit{Proceedings of SIGMOD}, pp. 19--34, 2018.

\bibitem{yang2018hotpotqa}
Z. Yang et al., ``HotpotQA: A Dataset for Diverse, Explainable Multi-hop Question Answering,'' in \textit{Proceedings of EMNLP}, pp. 2369--2380, 2018.

\bibitem{ho2020constructing}
X. Ho et al., ``Constructing A Multi-hop QA Dataset for Comprehensive Evaluation of Reasoning Steps,'' in \textit{Proceedings of COLING}, pp. 6609--6625, 2020.

\bibitem{wei2022chain}
J. Wei et al., ``Chain-of-Thought Prompting Elicits Reasoning in Large Language Models,'' in \textit{Advances in NeurIPS}, vol. 35, pp. 24824--24837, 2022.

\bibitem{liu2024lost}
Y. Liu et al., ``Lost in the Middle: How Language Models Use Long Contexts,'' \textit{Trans. Assoc. Comput. Linguist.}, vol. 12, pp. 157--173, 2024.

\bibitem{trivedi2022musique}
P. Trivedi et al., ``MuSiQue: Multihop Questions via Single-hop Question Composition,'' \textit{Trans. Assoc. Comput. Linguist.}, vol. 10, pp. 539--554, 2022.
...
J. Devlin et al., ``BERT: Pre-training of Deep Bidirectional Transformers for Language Understanding,'' in \textit{Proceedings of NAACL-HLT}, pp. 4171--4186, 2019.
